...
public class mxPerimeter
{
	...
	public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.mxgraph.tool.view.mxPerimeter.mxPerimeterFunction#apply
		 */
	...
	public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.mxgraph.tool.view.mxPerimeter.mxPerimeterFunction#apply(com.mxgraph.tool.utils.mxRectangle, com.mxgraph.tool.view.mxCellState, com.mxgraph.tool.view.mxCellState, boolean, com.mxgraph.tool.utils.mxPoint)
		 */
		public mxPoint apply(mxRectangle bounds, mxCellState vertex,
				mxPoint next, boolean orthogonal)
		{
