...
public class mxEdgeStyle
{
	...
	public static mxEdgeStyleFunction EntityRelation = new mxEdgeStyleFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.mxgraph.tool.view.mxEdgeStyle.mxEdgeStyleFunction#apply(com.mxgraph.tool.view.mxCellState, com.mxgraph.tool.view.mxCellState, com.mxgraph.tool.view.mxCellState, java.util.List, java.util.List)
		 */
